...
module_dir="/data/adb/modules/tpclash4android"

[ -n "$(magisk -v | grep lite)" ] && module_dir=/data/adb/lite_modules/tpclash4android
...
wait_until_login(){
  ...
  local test_file="/sdcard/Android/.TPCLASHTEST"
  true > "$test_file"
